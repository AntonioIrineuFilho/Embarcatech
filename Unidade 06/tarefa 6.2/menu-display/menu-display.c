...
void pwm_red_blue() {
  setup_pwm_led(LED_G, &slice_led_b, led_b_level); // Configura o PWM para o LED azul
...
void pwm_main() {
    ...
    while (true) {
        ...
        pwm_set_gpio_level(LED_G, vrx_value); // Ajusta o brilho do LED azul com o valor do eixo X
